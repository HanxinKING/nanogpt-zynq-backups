...
`ifdef INT8_TILE_MODE
    ...
    initial begin
        $readmemh("../reference/ln1.mem", tile_ln1_rom);
        $readmemh("../reference/q.mem", tile_q_rom);
        $readmemh("../reference/k.mem", tile_k_rom);
        $readmemh("../reference/v.mem", tile_v_rom);
        $readmemh("../reference/attn.mem", tile_attn_rom);
        $readmemh("../reference/res1.mem", tile_res1_rom);
        $readmemh("../reference/ln2.mem", tile_ln2_rom);
        $readmemh("../reference/ffn.mem", tile_ffn_rom);
    end
`endif
