set proj_dir [file normalize "F:/nanogpt_ZYNQ/nanogpt_ZYNQ/fpga/nano_gpt"]
set proj [file join $proj_dir "nano_gpt.xpr"]
if {[file exists $proj]} {
    open_project $proj
} else {
    create_project nano_gpt $proj_dir -part xc7z020clg484-2
}
set_property source_mgmt_mode All [current_project]

foreach stale_file [get_files -quiet *dont_touch.xdc] {
...
set chain_rtl [list \
    "F:/nanogpt_ZYNQ/nanogpt_ZYNQ/fpga/nano_gpt/rtl/layernorm_hls_wrapper.v" \
    "F:/nanogpt_ZYNQ/nanogpt_ZYNQ/fpga/nano_gpt/rtl/gelu_embed_hls_wrapper.v" \
    "F:/nanogpt_ZYNQ/nanogpt_ZYNQ/fpga/nano_gpt/rtl/tiled_matmul_hls_wrapper.v" \
    "F:/nanogpt_ZYNQ/nanogpt_ZYNQ/fpga/nano_gpt/rtl/mha_hls_wrapper.v" \
    "F:/nanogpt_ZYNQ/nanogpt_ZYNQ/fpga/nano_gpt/rtl/pl_uart_ps_bridge.v" \
    "F:/nanogpt_ZYNQ/nanogpt_ZYNQ/fpga/nano_gpt/rtl/hls_kernel_chain_axis_top.v" \
    "F:/nanogpt_ZYNQ/nanogpt_ZYNQ/fpga/nano_gpt/rtl/hls_kernel_chain_axis_full_only_core.v" \
    "F:/nanogpt_ZYNQ/nanogpt_ZYNQ/fpga/nano_gpt/rtl/hls_kernel_chain_axis_wrapper.v" \
]
...
set_property file_type Verilog [get_files "F:/nanogpt_ZYNQ/nanogpt_ZYNQ/fpga/nano_gpt/rtl/hls_kernel_chain_axis_wrapper.v"]
set uart_xdc "F:/nanogpt_ZYNQ/nanogpt_ZYNQ/fpga/nano_gpt/constraints/uart_sp2_v12_pl.xdc"
...
set timing_xdc "F:/nanogpt_ZYNQ/nanogpt_ZYNQ/fpga/nano_gpt/constraints/timing_100mhz.xdc"
...
foreach pattern [list \
    "F:/paper_figures/paper_figures/tiled_matmul/sol1/impl/ip/hdl/verilog/*.v" \
    "F:/paper_figures/paper_figures/mha_kernel/sol1/impl/ip/hdl/verilog/*.v" \
    "F:/paper_figures/paper_figures/layernorm_kernel/sol1/impl/ip/hdl/verilog/*.v" \
    "F:/paper_figures/paper_figures/gelu_embed_kernel/sol1/impl/ip/hdl/verilog/*.v" \
] {
...
foreach stale_dir [list \
    "F:/nanogpt_ZYNQ/nanogpt_ZYNQ/fpga/nano_gpt/nano_gpt.srcs/sources_1/bd/$bd_name" \
    "F:/nanogpt_ZYNQ/nanogpt_ZYNQ/fpga/nano_gpt/nano_gpt.gen/sources_1/bd/$bd_name" \
    "F:/nanogpt_ZYNQ/nanogpt_ZYNQ/fpga/nano_gpt/nano_gpt.gen/sources_1/bd/mref/hls_kernel_chain_axis_top" \
    "F:/nanogpt_ZYNQ/nanogpt_ZYNQ/fpga/nano_gpt/nano_gpt.gen/sources_1/bd/mref/hls_kernel_chain_axis_wrapper" \
] {
...
set ddr_clk_mhz 100.0
if {[info exists ::env(DDR_CLK_MHZ)] && $::env(DDR_CLK_MHZ) ne ""} {
    set ddr_clk_mhz $::env(DDR_CLK_MHZ)
}
set pl_clk_hz [expr {int(round(double($pl_clk_mhz) * 1000000.0))}]
set ddr_clk_hz [expr {int(round(double($ddr_clk_mhz) * 1000000.0))}]
puts "SYSTEM_DDR_PL_CLK_MHZ=$pl_clk_mhz"
puts "SYSTEM_DDR_PL_CLK_HZ=$pl_clk_hz"
puts "SYSTEM_DDR_AXI_CLK_MHZ=$ddr_clk_mhz"
puts "SYSTEM_DDR_AXI_CLK_HZ=$ddr_clk_hz"
...
set_property -dict [list \
    ...
    CONFIG.PCW_FPGA1_PERIPHERAL_FREQMHZ $ddr_clk_mhz \
...
set realized_ddr_clk_hz [get_property CONFIG.FREQ_HZ [get_bd_pins processing_system7_0/FCLK_CLK1]]
if {$realized_ddr_clk_hz ne ""} {
    set ddr_clk_hz $realized_ddr_clk_hz
    puts "SYSTEM_DDR_REALIZED_AXI_CLK_HZ=$ddr_clk_hz"
}
...
create_bd_cell -type ip -vlnv xilinx.com:ip:axi_clock_converter:2.1 core_ddr_cdc
create_bd_cell -type ip -vlnv xilinx.com:ip:axi_clock_converter:2.1 dma_mm2s_cdc
create_bd_cell -type ip -vlnv xilinx.com:ip:axi_clock_converter:2.1 dma_s2mm_cdc
...
connect_bd_net [get_bd_pins processing_system7_0/FCLK_CLK0] \
               ...
               [get_bd_pins rst_ps7_0_75M/slowest_sync_clk] \
               ...
               [get_bd_pins core_ddr_cdc/s_axi_aclk] \
               [get_bd_pins dma_mm2s_cdc/s_axi_aclk] \
               [get_bd_pins dma_s2mm_cdc/s_axi_aclk]

connect_bd_net [get_bd_pins processing_system7_0/FCLK_CLK1] \
               [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] \
               [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] \
               [get_bd_pins smartconnect_ddr/aclk] \
               [get_bd_pins core_ddr_cdc/m_axi_aclk] \
               [get_bd_pins dma_mm2s_cdc/m_axi_aclk] \
               [get_bd_pins dma_s2mm_cdc/m_axi_aclk]
...
connect_bd_net [get_bd_pins rst_ps7_0_75M/interconnect_aresetn] \
...
connect_bd_net [get_bd_pins rst_ps7_0_75M/peripheral_aresetn] \
               ...
               [get_bd_pins core_ddr_cdc/s_axi_aresetn] \
               [get_bd_pins dma_mm2s_cdc/s_axi_aresetn] \
               [get_bd_pins dma_s2mm_cdc/s_axi_aresetn]
...
connect_bd_net [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] \
               [get_bd_pins core_ddr_cdc/m_axi_aresetn] \
               [get_bd_pins dma_mm2s_cdc/m_axi_aresetn] \
               [get_bd_pins dma_s2mm_cdc/m_axi_aresetn]
...
connect_bd_intf_net [get_bd_intf_pins axi_dma_0/M_AXI_MM2S] [get_bd_intf_pins dma_mm2s_cdc/S_AXI]
connect_bd_intf_net [get_bd_intf_pins dma_mm2s_cdc/M_AXI] [get_bd_intf_pins smartconnect_ddr/S00_AXI]
connect_bd_intf_net [get_bd_intf_pins axi_dma_0/M_AXI_S2MM] [get_bd_intf_pins dma_s2mm_cdc/S_AXI]
connect_bd_intf_net [get_bd_intf_pins dma_s2mm_cdc/M_AXI] [get_bd_intf_pins smartconnect_ddr/S01_AXI]
connect_bd_intf_net [get_bd_intf_pins hls_kernel_chain_axis_top_0/m_axi_ddr] [get_bd_intf_pins core_ddr_cdc/S_AXI]
connect_bd_intf_net [get_bd_intf_pins core_ddr_cdc/M_AXI] [get_bd_intf_pins smartconnect_ddr/S02_AXI]
...
set system_bd [get_files "F:/nanogpt_ZYNQ/nanogpt_ZYNQ/fpga/nano_gpt/nano_gpt.srcs/sources_1/bd/system/system.bd"]
set_property synth_checkpoint_mode None $system_bd
reset_target all $system_bd
generate_target all $system_bd

make_wrapper -files [get_files "F:/nanogpt_ZYNQ/nanogpt_ZYNQ/fpga/nano_gpt/nano_gpt.srcs/sources_1/bd/system/system.bd"] -top
add_files -norecurse "F:/nanogpt_ZYNQ/nanogpt_ZYNQ/fpga/nano_gpt/nano_gpt.gen/sources_1/bd/system/hdl/system_wrapper.v"
set_property source_mgmt_mode All [current_project]
update_compile_order -fileset sources_1
